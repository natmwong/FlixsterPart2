...
/**
 * [RecyclerView.Adapter] that can display a [CurrentMovie]
 */
class CurrentMoviesRecyclerViewAdapter (private val movies: List<CurrentMovie>)
    : RecyclerView.Adapter<CurrentMoviesRecyclerViewAdapter.MovieViewHolder>() {
